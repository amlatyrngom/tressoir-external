...
(() => {
  ...
  function resolveToLabelEnd(events, context) {
    ...
    media = push(media, [["exit", text9, context], events[close2 - 2], events[close2 - 1], ["exit", label4, context]]);
  ...
  function compiler(options) {
    ...
    function opener2(create3, and) {
      return open;
      function open(token) {
        enter2.call(this, create3(token), token);
        if (and)
          and.call(this, token);
      }
    }
        ...
        if (reference) {
          ...
          if (settings.reference) {
            settings.reference.call(
              ...
              reference,
              { start: previous4, end: next2 },
              value2.slice(start - 1, end)
            );
          }
          previous4 = next2;
        } else {
          characters2 = value2.slice(start - 1, end);
          queue += characters2;
  ...
  function directiveToMarkdown(options) {
    ...
    function attributes4(node2, state) {
      ...
      for (key2 in attributes5) {
        if (own5.call(attributes5, key2) && attributes5[key2] !== void 0 && attributes5[key2] !== null) {
          ...
          if (key2 === "id") {
            ...
            while (++index2 < list4.length) {
              ;
              (settings.preferShortcut !== false && shortcut.test(list4[index2]) ? classesList : classesFullList).push(list4[index2]);
            }
    ...
    function quoted(key2, value2, node2, state) {
      if (settings.collapseEmptyAttributes !== false && !value2)
        return key2;
  ...
  function factoryAttributes(effects, ok3, nok, attributesType, attributesMarkerType, attributeType, attributeIdType, attributeClassType, attributeNameType, attributeInitializerType, attributeValueLiteralType, attributeValueType, attributeValueMarker, attributeValueData, disallowEol) {
    ...
    function shortcutStartAfter(code4) {
      if (code4 === null || code4 === 34 || code4 === 35 || code4 === 39 || code4 === 46 || code4 === 60 || code4 === 61 || code4 === 62 || code4 === 96 || code4 === 125 || markdownLineEndingOrSpace(code4)) {
        return nok(code4);
      }
      const valueType = (
        /** @type {TokenType} */
    ...
    function shortcut2(code4) {
      if (code4 === null || code4 === 34 || code4 === 39 || code4 === 60 || code4 === 61 || code4 === 62 || code4 === 96) {
        return nok(code4);
      }
      if (code4 === 35 || code4 === 46 || code4 === 125 || markdownLineEndingOrSpace(code4)) {
        const valueType = (
          /** @type {TokenType} */
          type + "Value"
        );
    ...
    function valueBefore(code4) {
      if (code4 === null || code4 === 60 || code4 === 61 || code4 === 62 || code4 === 96 || code4 === 125 || disallowEol && markdownLineEnding(code4)) {
        return nok(code4);
      }
      if (code4 === 34 || code4 === 39) {
    ...
    function valueUnquoted(code4) {
      ...
      if (code4 === 125 || markdownLineEndingOrSpace(code4)) {
    ...
    function valueQuotedAfter(code4) {
      return code4 === 125 || markdownLineEndingOrSpace(code4) ? between(code4) : end(code4);
    }
    function end(code4) {
      if (code4 === 125) {
        effects.enter(attributesMarkerType);
  ...
  function factoryLabel2(effects, ok3, nok, type, markerType, stringType, disallowEol) {
    ...
    function data(code4) {
      if (code4 === null || size > 999) {
        return nok(code4);
      }
      if (code4 === 91 && ++balance > 32) {
        return nok(code4);
      }
      if (code4 === 93 && !balance--) {
        effects.exit("chunkText");
      ...
      effects.consume(code4);
      return code4 === 92 ? dataEscape : data;
    }
    function dataEscape(code4) {
      if (code4 === 91 || code4 === 92 || code4 === 93) {
        effects.consume(code4);
        size++;
        return data;
  ...
  function factoryName(effects, ok3, nok, type) {
    ...
    function name(code4) {
      ...
      effects.exit(type);
      return self2.previous === 45 || self2.previous === 95 ? nok(code4) : ok3(code4);
    }
  }
  ...
  function tokenizeDirectiveContainer(effects, ok3, nok) {
    ...
    function sequenceOpen(code4) {
      ...
      return factoryName.call(self2, effects, afterName, nok, "directiveContainerName")(code4);
    }
    function afterName(code4) {
      return code4 === 91 ? effects.attempt(label, afterLabel, afterLabel)(code4) : afterLabel(code4);
    }
    function afterLabel(code4) {
      return code4 === 123 ? effects.attempt(attributes, afterAttributes, afterAttributes)(code4) : afterAttributes(code4);
    }
    ...
    function openAfter(code4) {
      ...
      if (markdownLineEnding(code4)) {
        ...
        return effects.attempt(nonLazyLine, contentStart, after)(code4);
      }
      return nok(code4);
    }
    function contentStart(code4) {
      ...
      if (markdownLineEnding(code4)) {
        return effects.check(nonLazyLine, emptyContentNonLazyLineAfter, after)(code4);
      }
    ...
    function lineStart(code4) {
      return effects.attempt({
        tokenize: tokenizeClosingFence,
        partial: true
      }, afterContent, initialSize ? factorySpace(effects, chunkStart, "linePrefix", initialSize + 1) : chunkStart)(code4);
    }
    function chunkStart(code4) {
      if (code4 === null) {
        return afterContent(code4);
      }
      if (markdownLineEnding(code4)) {
        return effects.check(nonLazyLine, chunkNonLazyStart, afterContent)(code4);
      }
      return chunkNonLazyStart(code4);
    }
    function contentContinue(code4) {
      if (code4 === null) {
      ...
      if (markdownLineEnding(code4)) {
        return effects.check(nonLazyLine, nonLazyLineAfter, lineAfter)(code4);
      }
      effects.consume(code4);
      return contentContinue;
    }
    function chunkNonLazyStart(code4) {
    ...
    function emptyContentNonLazyLineAfter(code4) {
      effects.enter("directiveContainerContent");
      return lineStart(code4);
    }
    function nonLazyLineAfter(code4) {
      effects.consume(code4);
      const t = effects.exit("chunkDocument");
      self2.parser.lazy[t.start.line] = false;
      return lineStart;
    }
    function lineAfter(code4) {
      const t = effects.exit("chunkDocument");
      self2.parser.lazy[t.start.line] = false;
      return afterContent(code4);
    }
    function afterContent(code4) {
  ...
  function tokenizeDirectiveLeaf(effects, ok3, nok) {
    ...
    function afterName(code4) {
      return code4 === 91 ? effects.attempt(label2, afterLabel, afterLabel)(code4) : afterLabel(code4);
    }
    function afterLabel(code4) {
      return code4 === 123 ? effects.attempt(attributes2, afterAttributes, afterAttributes)(code4) : afterAttributes(code4);
    }
    function afterAttributes(code4) {
      return factorySpace(effects, end, "whitespace")(code4);
    }
    function end(code4) {
      if (code4 === null || markdownLineEnding(code4)) {
  ...
  function previous2(code4) {
    return code4 !== 58 || this.events[this.events.length - 1][1].type === "characterEscape";
  }
  function tokenizeDirectiveText(effects, ok3, nok) {
    ...
    function afterName(code4) {
      return code4 === 58 ? nok(code4) : code4 === 91 ? effects.attempt(label3, afterLabel, afterLabel)(code4) : afterLabel(code4);
    }
    function afterLabel(code4) {
      return code4 === 123 ? effects.attempt(attributes3, afterAttributes, afterAttributes)(code4) : afterAttributes(code4);
    }
    function afterAttributes(code4) {
  ...
  function zwitch(key2, options) {
    ...
    function one5(value2, ...parameters) {
      ...
      if (value2 && own6.call(value2, key2)) {
        const id = String(value2[key2]);
        fn = own6.call(handlers2, id) ? handlers2[id] : one5.unknown;
      }
      if (fn) {
  ...
  function code(node2, _, state, info) {
    ...
    if (formatCodeAsIndented(node2, state)) {
      ...
      const value3 = state.indentLines(raw3, map2);
      exit5();
      return value3;
    }
    const tracker = state.createTracker(info);
  ...
  var deserializer = ($2, _) => {
    ...
    const unpair = (index2) => {
      ...
      return as(guard(type, value2), index2);
    };
    return unpair;
  };
      ...
      if (selector === null || selector === void 0) {
        ...
        if (isChild(properties)) {
          ...
          for (const [key2, value2] of Object.entries(properties)) {
            addProperty(schema, node2.properties, key2, value2);
          }
        }
      }
  ...
  function addChild(nodes, value2) {
    if (value2 === null || value2 === void 0) {
    } else if (typeof value2 === "number" || typeof value2 === "string") {
  ...
  function style(styles) {
    const result = [];
    for (const [key2, value2] of Object.entries(styles)) {
      result.push([key2, value2].join(": "));
    }
    return result.join("; ");
  }
  function createAdjustMap(values) {
    ...
    for (const value2 of values) {
      result.set(value2.toLowerCase(), value2);
    }
    return result;
  }
  ...
  function location(file) {
    ...
    function toOffset(point5) {
      if (point5 && typeof point5.line === "number" && typeof point5.column === "number" && !Number.isNaN(point5.line) && !Number.isNaN(point5.column)) {
        ...
        if (offset < indices[point5.line - 1])
          return offset;
      }
    }
  }
  ...
  var one3 = zwitch("type", { handlers: { root: root3, element: element3, text: text6, comment, doctype } });
  ...
  var OpenElementStack = class {
    ...
    constructor(document4, treeAdapter, handler2) {
...
\f\r "&'/<=>`.split(""), "\0	\n\f\r \"&'/<=>`".split("")]
  ...
  function element5(node2, index2, parent, state) {
    ...
    if (content3)
      selfClosing = false;
    if (attributes4 || !omit || !opening(node2, index2, parent)) {
