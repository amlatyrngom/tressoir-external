...
`IB/` means **Interpretable Blueprint**: the project-local, human-inspectable workspace shared by agents, harnesses, and sessions. This file is the canonical always-on guide. The user decides whether to reference or copy it from `CLAUDE.md`, `AGENTS.md`, a Pi context file, or another harness instruction mechanism.
...
5. Preserve existing project files, harness instructions, skills, and user-authored IB content. Report collisions rather than overwriting.
